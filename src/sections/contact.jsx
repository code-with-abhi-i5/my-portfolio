      ...
      <div className="contact-grid">
        ...
        <div>
          ...
          <div className="contact-details">
            {[
              { ico: '📧', lbl: 'Email', val: 'contact@abhijeetweb.in', href: 'mailto:contact@abhijeetweb.in' },
              { ico: '💬', lbl: 'WhatsApp', val: '+91 62993 90773', href: 'https://wa.me/916299390773' },
              { ico: '📍', lbl: 'Location', val: 'Jamshedpur, Jharkhand 🇮🇳', href: null },
          ...
          <div className="social-row reveal reveal-delay-2">
            <a href="https://github.com/code-with-abhi-i5" target="_blank" rel="noopener noreferrer" className="social-link">
              <GHIcon /> GitHub
            </a>
            <a href="https://linkedin.com/in/abhijeet-ghosh-tech" target="_blank" rel="noopener noreferrer" className="social-link">
              <LIIcon /> LinkedIn
            </a>
            <a href="https://wa.me/916299390773" target="_blank" rel="noopener noreferrer" className="social-link">
              <WAIcon /> WhatsApp
            </a>
            <a href="mailto:contact@abhijeetweb.in" target="_blank" rel="noopener noreferrer" className="social-link">
              <EmailIcon /> Email
            </a>
          </div>
        </div>
